...
PI_CARD="/dev/disk4"
ALPINE_BASE_IMAGE="https://dl-cdn.alpinelinux.org/alpine/v3.15/releases/aarch64/alpine-rpi-3.15.3-aarch64.tar.gz"
...
sudo diskutil partitionDisk $PI_CARD MBRFormat FAT32 RPI0 1g FREE RPISYS 0b
...
sudo diskutil unmountDisk $PI_CARD
